...
class NetworkConfig:
    ...
    # Paramètres d'entraînement (compatibles avec votre code)
    lrng_rate: float = 0.01  # learning rate
    it: int = 500  # iteration number
    ...
    def __post_init__(self):
        ...
        if self.r < 0:
            raise ValueError("Le coefficient de régularisation ne peut pas être négatif")